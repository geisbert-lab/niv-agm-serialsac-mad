...
mv "${PREFIX}Aligned.out.bam" "${PREFIX}aligned.bam"
echo ""
...
# fixmate
CMD="samtools fixmate --threads 8 -m '${PREFIX}aligned.bam' '${PREFIX}fixmate.bam'"
mesg "CMD: $CMD"
eval "$CMD"
...
# sort
CMD="samtools sort --threads 8 '${PREFIX}fixmate.bam' > '${PREFIX}sorted.bam'"
mesg "CMD: $CMD"
eval "$CMD"
